  ...
  document.querySelectorAll(".nav-toggler").forEach((e) => {
    e.addEventListener("click", () => {
      ...
      (!root.classList.contains("mn--min") &&
        ...
        : (root.classList.toggle("mn--min"), root.classList.toggle("mn--max"))
    })
  }),
...
mainNav &&
  ...
  (miniNavContentsCollapse = miniNavContents.map((e) => {
    if (
      ...
      return (
        e.addEventListener("transitionend", () => n.classList.remove("open"), {
          once: !0,
        }),
        t
      )
    ...
    if (
      ...
      t.islink && e.preventDefault(),
        ...
        ["click", "touchend"].forEach((e) =>
          document.addEventListener(e, hideAllMiniNavContent, { once: !0 })
        )
    }
  },
  buildNav = () => {
  ...
  const o = document.getElementById("dm_colorSchemesContainer"),
    ...
    r = (t) => {
      ...
      return (
        ...
        "bootstrap" == t ? (bootstrapLinkEl = o) : (niftyLinkEl = o),
        o
      )
    },
