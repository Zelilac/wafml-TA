                ...
                <div class="content__wrap">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Presiden BEM</li>
                        </ol>
                    </nav>
                                        ...
                                        <div class="row gx-3 gy-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control triggerBtn" id="periode"
                                                            ...
                                                            value="{{ $nGetDataPresidenBem >= 1 ? $fGetDataPresidenBem->periode : $filter_periode }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="hidden" id="nim_ketua" name="nim_ketua"
                                                            value="{{ $nGetDataPresidenBem >= 1 ? $fGetDataPresidenBem->nim_ketua : '' }}">
                                                        <input type="text" class="form-control triggerBtn"
                                                            id="nama_ketua" name="nama_ketua"
                                                            value="{{ $nGetDataPresidenBem >= 1 && $fGetDataPresidenBem->mahasiswa_ketua ? $fGetDataPresidenBem->mahasiswa_ketua->nama : '' }}"
                                                            {{ $canInsert || $canUpdate ? '' : 'disabled' }}>
                                                        <span class="input-group-text text-danger">*</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="hidden" id="nim_wakil" name="nim_wakil"
                                                            value="{{ $nGetDataPresidenBem >= 1 ? $fGetDataPresidenBem->nim_wakil : '' }}">
                                                        <input type="text" class="form-control triggerBtn"
                                                            id="nama_wakil" name="nama_wakil"
                                                            value="{{ $nGetDataPresidenBem >= 1 && $fGetDataPresidenBem->mahasiswa_wakil ? $fGetDataPresidenBem->mahasiswa_wakil->nama : '' }}"
                                                            {{ $canInsert || $canUpdate ? '' : 'disabled' }}>
                                                        <span class="input-group-text text-danger">*</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @if ($nGetDataPresidenBem >= 1 && !empty($fGetDataPresidenBem['foto_ketua']))
                                                        <div style="margin-top: .75rem;">
                                                            <div class="row">
                                                                <div class="col-auto">
                                                                    <a href="{{ asset('images/foto/' . $fGetDataPresidenBem['foto_ketua']) }}"
                                                                        target="_blank" style="text-decoration: underline;">
                                                                        <img src="{{ asset('images/foto/' . $fGetDataPresidenBem['foto_ketua']) }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @if ($nGetDataPresidenBem >= 1 && !empty($fGetDataPresidenBem['foto_wakil']))
                                                        <div style="margin-top: .75rem;">
                                                            <div class="row">
                                                                <div class="col-auto">
                                                                    <a href="{{ asset('images/foto/' . $fGetDataPresidenBem['foto_wakil']) }}"
                                                                        target="_blank" style="text-decoration: underline;">
                                                                        <img src="{{ asset('images/foto/' . $fGetDataPresidenBem['foto_wakil']) }}"
                                                                            style="width: 50px; height: 50px; object-fit: cover;">
                                                                    </a>
                                                                </div>
                                                            </div>
            ...
            <script>
                $(document).ready(function() {
                    $("#nama_ketua").autocomplete({
                            source: "{{ route('master-presiden-bem.get-mahasiswa') }}",
                            minLength: 2,
            ...
            <script>
                ...
                @if ($canInsert || $canUpdate)
                    ...
                    function doSubmitForm(doc_id) {
                        ...
                        @if ($nGetDataPresidenBem >= 1)
                            var id_presiden_bem = '{{ $id_presiden_bem }}';
                            var url = "{{ url($currentRoute) . '/update/' . $id_presiden_bem }}";
                            var method = "put";
                        @else
                        ...
                        @if ($nGetDataPresidenBem >= 1)
                            formData.append('id_presiden_bem', id_presiden_bem);
                        @endif
                                    ...
                                    Swal.fire({
                                        ...
                                        @else
                                            ...
                                            window.location.href =
                                                '{!! url($currentRoute . "?filter_periode={$filter_periode}") !!}';
                                        @endif
                                    });
                                } else {
                                ...
                                <div class="card-body">
                                    <div class="card-title">
                                        <form action="{{ url($currentRoute) }}" method="get" id="form_filter">
                                            ...
                                            <div class="row gy-2 gx-2">
                                                ...
                                                @if ($canInsert)
                                                    <div class="col-auto col-md-auto">
                                                        <a href="{{ url($currentRoute) . "?filter_periode={$filter_periode}&act=tambah" }}"
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control form-control-sm triggerBtn"
                                                        placeholder="Pencarian Presiden BEM" name="filter_keyword"
                                    ...
                                    <div class="table-responsive text-nowrap">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($fGetDataPresidenBem as $item)
                                                    <tr>
                                                        <td class="align-middle" style="cursor: pointer;"
                                                            onclick="openModal('Edit Presiden BEM', '{{ $item->id }}')">
                                                            {{ $posisiHalaman + $loop->iteration }}.
                                                        </td>
                                                        {{-- <td class="align-middle">
                                                            <img src="{{ asset('images/foto/' . $item->foto_ketua) }}"
                                                                style="max-width: 200px;"><br><b>File PresidenBem</b>: <a
